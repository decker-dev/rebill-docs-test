...
The payment methods are categorized into three main types: card, cash, and transfer. For instance, in Argentina, 'cash' may refer to 'PagoFacil', in Colombia to 'Efecty', and in Mexico to 'Paynet'.
