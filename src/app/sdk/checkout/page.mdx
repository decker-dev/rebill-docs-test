...
The payment methods are grouped into three main categories: card, cash, and transfer. The payment methods are grouped into three main categories: card, cash, and transfer. For example, in Argentina, 'cash' may represent 'PagoFacil', in Colombia 'Efecty', and in Mexico 'Paynet'. For example, in Argentina, 'cash' may represent 'PagoFacil', in Colombia 'Efecty', and in Mexico 'Paynet'. The payment methods are grouped into three main categories: card, cash, and transfer. For example, in Argentina, 'cash' may represent 'PagoFacil', in Colombia 'Efecty', and in Mexico 'Paynet'.
